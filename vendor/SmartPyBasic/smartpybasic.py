...
import vendor.SmartPyBasic.browser as browser
...
if __name__ == "__main__":
    ...
    parser.add_argument('filename', metavar='f', type=str, help='')
    ...
    context = globals()
    context['setOutput'] = browser.setOutput
    context['alert'] = browser.alert
    context['window'] = browser.window
    context['addTest'] = smartpyio.addTest
    context['h1'] = lambda x: []
    context['h2'] = lambda x: []
    context['h3'] = lambda x: []
    context['h4'] = lambda x: []
    exec(adaptedCode, context)
